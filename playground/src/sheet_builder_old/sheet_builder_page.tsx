...
// import { MdAdd, MdBuild, MdDescription, MdEdit, MdFileDownload } from 'react-icons/md'
// import { cancel, open } from './dialog_helpers'
...
//                     <Card>
//                         <CardContent>
//                             <ErrorList errors={store.sheet_builder.query_errors} />
//                         </CardContent>
//                     </Card>
//                 </Box>
//             )}
...
//                 <CardContent>
//                     <Toolbar>
//                         <Typography style={{ flexGrow: 1 }} color='textSecondary' variant='h5'>
//                             Custom sheet
//                         </Typography>
//                         <Tooltip title='View query'>
//                             <IconButton
//                                 onClick={e =>
//                                     open(store.sheet_builder.inspect_query_dialog, undefined)
//                                 }
//                                 size='large'
//                             >
//                                 <MdBuild />
...
//                             <IconButton onClick={e => download_sheet()} size='large'>
//                                 <MdFileDownload />
//                             </IconButton>
//                         </Tooltip>
//                         <Tooltip title='Create from excel'>
//                             <IconButton component='label' size='large'>
//                                 {create_button_loading ? <CircularProgress size={20} /> : <MdAdd />}
//                                 <input
//                                     type='file'
//                                     hidden
...
//             </Card>
//             <Dialog
//                 onClose={e => cancel(store.sheet_builder.inspect_query_dialog)}
...
//                                 <Box paddingLeft={5}>
//                                     <IconButton
//                                         onClick={e => copy_query_to_clipboard()}
//                                         size='large'
//                                     >
//                                         <MdDescription />
//                                     </IconButton>
...
//                 <Divider />
//                 <CardContent>
//                     <pre>{JSON.stringify(store.sheet_builder.query, undefined, 4)}</pre>
//                 </CardContent>
//             </Dialog>
//             <Dialog
//                 onClose={e => {
...
//                     <Grid container justifyContent='space-between' alignItems='center'>
//                         <Grid item>
//                             <Typography variant='h5'>Overwrite variant has categories</Typography>
//                         </Grid>
//                     </Grid>
//                 </CardContent>
//                 <Divider />
//                 <CardContent>
//                     There are {store.sheet_builder.uniqueness_dialog.duplicate_count} variant has
//                     category records from the excel sheet already in the database, do you want to
//                     delete these?
//                     {store.sheet_builder.uniqueness_dialog.hero_category_count > 0
