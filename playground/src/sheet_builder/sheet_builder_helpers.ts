...
import { company_mutate, company_query, company_query_paginated } from './api_helpers'
import { store } from '../stores/store'
import { show_toast } from './shared_helpers'

export const copy_query_to_clipboard = () => {
    navigator.clipboard.writeText(JSON.stringify(store.sheet_builder.query, undefined, 4))
}
